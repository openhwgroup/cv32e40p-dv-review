...
No present in this directory, but of importance to this test is the CSR definition file:
  ...
  * core-v-verif/cv32e40p/env/corev-dv/cv32e40p_csr_template.yaml
...
Future Improvements:
  ...
  * Additional privilege levels.
    - While the cv32e40p only has Machine and User privilege levels, future processors may
